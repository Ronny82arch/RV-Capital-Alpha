...
function mapToPortfolioState(
  ...
  return {
    ...
    positions: positions.map(pos => ({
      ...
      capitalAllocated: Number(pos.capital_allocated),
      stopLoss: Number(pos.stop_loss),
      takeProfit: Number(pos.take_profit),
      entryDate: pos.entry_date,
      status: pos.status as any,
      closePrice: pos.close_price ? Number(pos.close_price) : undefined,
      closeDate: pos.close_date || undefined,
      realizedPnl: pos.realized_pnl ? Number(pos.realized_pnl) : undefined,
      realizedPnlPercent: pos.realized_pnl_percent ? Number(pos.realized_pnl_percent) : undefined,
      currentPrice: pos.current_price ? Number(pos.current_price) : undefined,
      unrealizedPnl: pos.unrealized_pnl ? Number(pos.unrealized_pnl) : undefined,
      unrealizedPnlPercent: pos.unrealized_pnl_percent ? Number(pos.unrealized_pnl_percent) : undefined,
      tags: pos.tags || [],
