...
function mapToPortfolioState(
  ...
  return {
    ...
    positions: positions.map(pos => ({
      ...
      realizedPnl: pos.realized_pnl != null ? Number(pos.realized_pnl) : 0,
      realizedPnlPercent: pos.realized_pnl_percent != null ? Number(pos.realized_pnl_percent) : 0,
      currentPrice: pos.current_price != null ? Number(pos.current_price) : undefined,
      unrealizedPnl: pos.unrealized_pnl != null ? Number(pos.unrealized_pnl) : 0,
      unrealizedPnlPercent: pos.unrealized_pnl_percent != null ? Number(pos.unrealized_pnl_percent) : 0,
      tags: pos.tags || [],
      portfolio: pos.custom_portfolio_name || 'Da Assegnare',
      logoUrl: pos.logo_url || undefined,
      excludeFromCopyTrading: pos.exclude_from_copy_trading || false,
    })),
