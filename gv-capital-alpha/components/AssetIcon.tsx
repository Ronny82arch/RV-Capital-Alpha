...
export default function AssetIcon({ symbol }: { symbol: string }) {
  const s = symbol.toUpperCase();
  let url = `https://api.dicebear.com/7.x/initials/svg?seed=${s}&backgroundColor=1e293b&textColor=ffffff`;
  ...
  return (
    <img 
      src={url} 
      alt={symbol} 
      style={{ width: '18px', height: '18px', borderRadius: '50%', objectFit: 'contain', background: '#fff' }}
      onError={(e) => { 
