...
import { savePushSubscription, getPushSubscriptions } from '@/lib/supabase/storage';

export const dynamic = 'force-dynamic';

// Public VAPID Key (usata dal client per registrare la PushSubscription)
const VAPID_PUBLIC_KEY = process.env.NEXT_PUBLIC_VAPID_PUBLIC_KEY || 'BEl62iUYgUivxIkv69yViEuiBIa40yYyO7yJk316rU2B1mN14Hq4v2T4R1E2T3y4U5v6W7x8Y9z0abc12345678';
